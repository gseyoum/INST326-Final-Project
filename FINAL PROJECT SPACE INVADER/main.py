...
#Class directly adapted from https://www.youtube.com/watch?v=Q-__8Xw9KTM.
#Small edits were made to fit the design of our project
class Laser:
...
#Although the class name is the same from https://www.youtube.com/watch?v=Q-__8Xw9KTM
#we have implemented 2 brand new meathods called healthbar and scoreboard and made various 
#additions to the other functions in this class.
...
#Although the class name is the same from https://www.youtube.com/watch?v=Q-__8Xw9KTM
#we have implemented a brand new meathod called move_zigzag which makes the enemies fall
#down the screen in a zig zag form rather then straight down.
#additions to the other functions in this class.
class Enemy(Ship):
    ...
    def move_zigzag(self, speed): #Rohan
